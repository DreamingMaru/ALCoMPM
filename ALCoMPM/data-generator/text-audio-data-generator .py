...
## This is slightly modified version of MELD data format:
## The fourth column is replaced by an audio vector.
## The audio vector is generated by audio_to_vector.py
...
# The audio vectors are stored in json format
with open(path + "total_dataset.json", 'r') as file:
    sound = json.load(file)

# The remaining part is almost the same as text-data-generator.py
